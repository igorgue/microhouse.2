...
tidalInst <- mkTidalWith [(superdirtTarget { oLatency = -0.02 }, [superdirtShape]), (editorTarget, [editorShape])] (defaultConfig {cEnableLink = True, cFrameTimespan = 1/50, cProcessAhead = 1/20})
